...
from mountainExtract import Ui_MainWindow as mountainWindow
...
class MountainExtract(BaseMainWindow, mountainWindow):
    ...
    def openImg(self):
        ...
        """
        try:
            fname ,_ = QFileDialog.getOpenFileName(self,'Open File','function/mountain_foot/data',
    ...
    def cleanImg(self):
        bg = Image.open('function/axis_trans/resource/background.jpg')
    ...
    def saveImg(self):
        if self.resultImg is None:
            ...
            fname, ftype = QFileDialog.getSaveFileName(self, '保存图片', 'function/mountain_foot/result', 'Image files (*.jpg *.png *.jpeg)')
